...
.modal-box h3{font-family:'Fraunces',serif;font-size:1.25rem;font-weight:700;color:var(--navy);margin-bottom:20px;}
...
const MyBookings = () => {
  ...
  const [reviewModal, setReviewModal] = useState(null); // { bookingId, pgId }
              ...
              return (
                <div key={b._id} className={`booking-card${isCancelled ? " cancelled" : ""}`}>
                  ...
                  <div className="bc-actions">
                    <button
                      className="btn-view"
                      onClick={() => navigate(`/user/property/${b.pgId?._id}`, { state: { bookingStatus: b.bookingStatus } })}
                    >
                      View Property
                    </button>
